...
#elif defined(MCU_IS_STM32F4XX)  // STM's STM32F4XX, Non-HAL
...
#elif defined(MCU_IS_STM32F4XX_HAL)  // STM's STM32F4XX, HAL
//using *GPIOB9* as nRESET
#define  M8266WIFI_nRESET_GPIO_RCC_CLOCK_EN				  __HAL_RCC_GPIOB_CLK_ENABLE()
#define  M8266WIFI_nRESET_GPIO											GPIOC
#define  M8266WIFI_nRESET_PIN												GPIO_PIN_5
...
#elif defined(MCU_IS_STM32F4XX)  // STM's STM32F4XX, Non_HAL
//using *GPIOD3* as nCS
...
#elif defined(MCU_IS_STM32F4XX_HAL)  // STM's STM32F4XX, HAL
//using *GPIOD3* as nCS
#define  M8266WIFI_SPI_nCS_GPIO_RCC_CLOCK_EN				__HAL_RCC_GPIOD_CLK_ENABLE()
#define  M8266WIFI_SPI_nCS_GPIO											GPIOC
#define  M8266WIFI_SPI_nCS_PIN											GPIO_PIN_4
...
#if defined(MCU_IS_STM32F1XX) || defined(MCU_IS_STM32F2XX) || defined(MCU_IS_STM32F3XX) || defined(MCU_IS_STM32F4XX) || defined(MCU_IS_STM32F4XX_HAL) || defined(MCU_IS_STM32F7XX)
#define MCU_IS_STM32
#endif
...
#elif defined(MCU_IS_STM32F2XX) || defined(MCU_IS_STM32F4XX)  	// STM's STM32F2XX, STM's STM32F4XX Non-HAL   
#define GPIO_InitStructure_AS_GPIO_OUTPUT(gpio,pin)						\
	GPIO_InitStructure.GPIO_Pin 	= pin;												\
...
#define GPIO_InitStructure_AS_GPIO_OUTPUT(gpio,pin)						\
  ...
  GPIO_InitStructure.GPIO_PuPd 	= GPIO_PuPd_UP;								\
	GPIO_Init(gpio, &GPIO_InitStructure)	
#elif defined(MCU_IS_STM32F7XX) || defined(MCU_IS_STM32F4XX_HAL) // STM's STM32F7XX, STM32F4XX HAL  
#define GPIO_InitStructure_AS_GPIO_OUTPUT(gpio,pin)						\
...
#elif   defined(MCU_IS_STM32F3XX) || defined(MCU_IS_STM32F4XX_HAL) || defined(MCU_IS_STM32F7XX)  // STM's STM32F3XX, STM32F4xx HAL, STM32F7XX, 
...
#define GPIO_InitStructure_AS_AF(gpio,pins)										\
  ...
  GPIO_InitStructure.GPIO_PuPd 	= GPIO_PuPd_UP;								\
	GPIO_Init(gpio, &GPIO_InitStructure)	
	#elif defined(MCU_IS_STM32F4XX_HAL) || defined(MCU_IS_STM32F7XX)  	// STM's STM32F4 HAL, STM32F7XX 
#define GPIO_InitStructure_AS_AF(gpio,pins)										\
...
#elif defined(MCU_IS_STM32F4XX_HAL)
...
#elif defined(MCU_IS_STM32F2XX) || defined(MCU_IS_STM32F3XX) || defined(MCU_IS_STM32F4XX) || defined(MCU_IS_STM32F4XX_HAL) || defined(MCU_IS_STM32F7XX)
#define GPIO_PinRemapSPI1																																	\
